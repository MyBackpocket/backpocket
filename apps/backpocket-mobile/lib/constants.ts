...
// API Configuration
export const API_URL = process.env.EXPO_PUBLIC_API_URL || "https://backpocket.my";

// Convex Configuration
export const CONVEX_URL = process.env.EXPO_PUBLIC_CONVEX_URL || "https://your-project.convex.cloud";
