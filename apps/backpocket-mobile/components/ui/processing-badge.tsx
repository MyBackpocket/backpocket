...
export function ProcessingBadge({ size = "sm" }: ProcessingBadgeProps) {
  ...
  return (
    <View style={[styles.container, isSmall ? styles.containerSm : styles.containerMd]}>
      <Animated.View style={{ transform: [{ rotate: spin }] }}>
        <Loader2 size={isSmall ? 10 : 12} color={brandColors.amber} strokeWidth={2.5} />
      </Animated.View>
      <Text style={[styles.text, isSmall ? styles.textSm : styles.textMd]}>Processing</Text>
    </View>
  );
}
