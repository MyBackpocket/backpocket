...
import { Check, ExternalLink, Moon, PanelTop, Smartphone, Sun } from "lucide-react-native";
    ...
    >
      <View style={styles.content}>
          ...
          {THEME_OPTIONS.map((option, index) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && <Check size={22} color={colors.primary} strokeWidth={2.5} />}
              </TouchableOpacity>
            );
          })}
        </Card>
        ...
        <Text style={[styles.helpText, { color: colors.mutedForeground }]}>
          Choose how Backpocket appears on your device. System follows your device's appearance
          settings.
        </Text>
        ...
        <Card style={styles.card}>
          ...
          >
            <View style={[styles.iconContainer, { backgroundColor: colors.muted }]}>
              <PanelTop
                size={20}
                color={settings.openLinksInApp ? brandColors.teal : colors.mutedForeground}
                strokeWidth={2}
              />
            </View>
            <View style={styles.optionContent}>
              <Text style={[styles.optionLabel, { color: colors.text }]}>In-App Browser</Text>
              <Text style={[styles.optionDescription, { color: colors.mutedForeground }]}>
          ...
          >
            ...
            <View style={styles.optionContent}>
              <Text style={[styles.optionLabel, { color: colors.text }]}>External Browser</Text>
              <Text style={[styles.optionDescription, { color: colors.mutedForeground }]}>
