    ...
    >
      <View style={styles.content}>
        ...
        <Card style={styles.card}>
          ...
          >
            <View style={[styles.iconContainer, { backgroundColor: colors.muted }]}>
              <Settings2 size={20} color={colors.mutedForeground} strokeWidth={2} />
            </View>
            <View style={styles.rowContent}>
              <Text style={[styles.rowLabel, { color: colors.text }]}>Open System Settings</Text>
              <Text style={[styles.rowDescription, { color: colors.mutedForeground }]}>
        ...
        <Text style={[styles.helpText, { color: colors.mutedForeground }]}>
          To fully enable notifications, you need to allow Backpocket to send notifications in your
