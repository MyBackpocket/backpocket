...
function SaveListItem({
  ...
  return (
    ...
    >
      ...
      >
        {save.imageUrl ? (
          <Image source={{ uri: save.imageUrl }} style={styles.saveThumbnail} resizeMode="cover" />
        ) : (
        ...
        <View style={styles.saveContent}>
          <Text style={[styles.saveTitle, { color: colors.text }]} numberOfLines={1}>
            {save.title || save.url}
          </Text>
          <Text style={[styles.saveUrl, { color: colors.mutedForeground }]} numberOfLines={1}>
