    ...
    >
      ...
      <Card style={styles.section}>
        <CardContent style={styles.profileContent}>
          {user?.imageUrl ? (
            ...
            <View style={[styles.avatar, { backgroundColor: brandColors.denim.DEFAULT }]}>
      ...
      <Card style={styles.section}>
        ...
        <View style={styles.versionRow}>
          ...
          <Text style={[styles.versionValue, { color: colors.mutedForeground }]}>1.0.0</Text>
        </View>
      </Card>

      {/* Sign Out */}
      <Button variant="outline" onPress={handleSignOut} style={styles.signOutButton}>
