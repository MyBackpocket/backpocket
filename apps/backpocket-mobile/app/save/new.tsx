        ...
        >
          ...
          <View
            style={[
              ...
              {
                backgroundColor:
                  colorScheme === "dark" ? `${brandColors.amber}15` : `${brandColors.amber}20`,
              },
            ]}
          >
            <Sparkles size={16} color={brandColors.amber} style={styles.infoBannerIcon} />
            <Text style={[styles.infoBannerText, { color: amberTextColors[colorScheme] }]}>
              We'll automatically fetch the page title, description, preview image, and article
              content for reader mode.
            </Text>
          </View>
          ...
          <Card style={styles.section}>
            <CardContent style={styles.sectionContent}>
              <Text style={[styles.sectionLabel, { color: colors.text }]}>Title (optional)</Text>
              <Input
              ...
              <Text style={[styles.hint, { color: colors.mutedForeground }]}>
                Override the auto-fetched title, or leave empty to use what we find
              </Text>
            </CardContent>
          </Card>
              ...
              {tags.length > 0 && (
                <View style={styles.tagsContainer}>
                  {tags.map((tag) => (
                    <TouchableOpacity
                      key={tag}
                      style={[styles.tag, { backgroundColor: `${brandColors.denim.DEFAULT}18` }]}
                      onPress={() => handleRemoveTag(tag)}
                      activeOpacity={0.7}
                    >
                      <Text style={[styles.tagText, { color: brandColors.denim.deep }]}>{tag}</Text>
