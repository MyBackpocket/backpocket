...
function EditCollectionModal({ visible, onClose, collection, colors }: EditCollectionModalProps) {
  ...
  const [defaultTags, setDefaultTags] = useState<string[]>(getTagNames(collection.defaultTags));
  ...
  const tagSuggestions = useMemo(() => {
    ...
    return existingTags.filter((t) => !lowerDefaultTags.includes(t.name.toLowerCase())).slice(0, 5);
  ...
  const handleRemoveTag = (tagName: string) => {
    setDefaultTags(defaultTags.filter((t) => t.toLowerCase() !== tagName.toLowerCase()));
  };
  ...
  const hasChanges =
    ...
    JSON.stringify([...defaultTags].sort()) !== JSON.stringify([...originalTagNames].sort());
    ...
    >
      ...
      >
        ...
        <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.modalTitle, { color: colors.text }]}>Edit Collection</Text>
          <View style={{ width: 24 }} />
        </View>
        ...
        >
          ...
          {/* Visibility */}
          <View style={styles.field}>
            <Text style={[styles.fieldLabel, { color: colors.text }]}>Visibility</Text>
          ...
          <View style={styles.field}>
            ...
            {defaultTags.length > 0 && (
              <View style={styles.defaultTagsRow}>
                {defaultTags.map((tagName) => (
                  ...
                  >
                    <Text style={[styles.defaultTagText, { color: brandColors.denim.faded }]}>
                      {tagName}
                    </Text>
                    <TouchableOpacity onPress={() => handleRemoveTag(tagName)} hitSlop={8}>
            ...
            <Text style={[styles.hint, { color: colors.mutedForeground }]}>
              These tags will be automatically added to new saves in this collection
            </Text>
          </View>
        </ScrollView>
          ...
          <View style={styles.siteInfo}>
            ...
            {save.visibility === "public" && (
              <View style={[styles.visibilityBadge, { backgroundColor: `${brandColors.mint}20` }]}>
                <Text style={[styles.badgeText, { color: brandColors.mint }]}>Public</Text>
              </View>
            )}
          </View>
  ...
  const renderEmpty = useCallback(() => {
    ...
    return (
      <View style={styles.emptyState}>
        ...
        <Text style={[styles.emptyTitle, { color: colors.text }]}>No saves in this collection</Text>
    ...
    return (
      <View style={styles.headerSection}>
        ...
        <Card style={styles.infoCard}>
          <View style={styles.infoCardInner}>
            ...
            <View style={styles.collectionHeader}>
              <View style={[styles.collectionIcon, { backgroundColor: colors.muted }]}>
              ...
              <View style={styles.collectionTitleSection}>
                ...
                <Text style={[styles.saveCount, { color: colors.mutedForeground }]}>
                  {collection._count?.saves ?? saves.length}{" "}
                  {(collection._count?.saves ?? saves.length) === 1 ? "save" : "saves"}
                </Text>
              </View>
            </View>
            ...
            <View style={[styles.metadataRow, { borderTopColor: colors.border }]}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      collection.visibility === "public" ? `${brandColors.mint}20` : colors.muted,
                  },
                ]}
              >
                <Text
            ...
            {/* Default Tags */}
            <View style={[styles.defaultTagsSection, { borderTopColor: colors.border }]}>
              ...
              {collection.defaultTags && collection.defaultTags.length > 0 ? (
                <View style={styles.defaultTagsList}>
                  {collection.defaultTags.map((tag) => (
                    ...
                    >
                      <Text style={[styles.defaultTagDisplayText, { color: brandColors.amber }]}>
                        {tag.name}
                      </Text>
                    </View>
                  ))}
                ...
                <Text style={[styles.noDefaultTags, { color: colors.mutedForeground }]}>
                  No default tags set
                </Text>
              )}
            </View>
        ...
        <View style={styles.headerActions}>
          <Button variant="outline" onPress={handleDeleteCollection} style={styles.deleteButton}>
