...
function VisibilityToggle({ visibility, onToggle, disabled, colors }: VisibilityToggleProps) {
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        ...
        {
          backgroundColor: isPublic ? `${brandColors.mint}20` : `${colors.mutedForeground}15`,
    ...
    <View style={styles.visibilitySection}>
      <Pressable
        ...
        style={({ pressed }) => [
          ...
          {
            backgroundColor: isPublic ? `${brandColors.mint}15` : `${colors.mutedForeground}10`,
            borderColor: isPublic ? brandColors.mint : colors.border,
          },
          pressed && { opacity: 0.8 },
      ...
      >
        ...
        <View style={styles.visibilityTextContainer}>
          ...
          <Text style={[styles.visibilitySubText, { color: colors.mutedForeground }]}>
            {isPublic ? "Visible on your public space" : "Only visible to you"}
          </Text>
        </View>
        <Text style={[styles.visibilityTapHint, { color: colors.mutedForeground }]}>
          Tap to change
        </Text>
      </Pressable>
    </View>
...
function QuickTagSection({ savedItem, colors }: QuickTagSectionProps) {
  ...
  const suggestedTags = allTags.filter((tag) => !selectedTags.includes(tag.name)).slice(0, 6);
  ...
  return (
    <View style={styles.tagSection}>
      <Text style={[styles.tagSectionLabel, { color: colors.mutedForeground }]}>Quick tags</Text>
      ...
      >
        ...
        {selectedTags.map((tagName) => (
          ...
          >
            <Text style={[styles.tagChipText, { color: "#FFFFFF" }]}>{tagName}</Text>
...
export default function ShareScreen() {
  ...
  }, [isLoaded, isSignedIn, hasShareIntent, params.url, extractUrl, resetShareIntent, visibility]);
          ...
          <View style={styles.content}>
            ...
            {status === "loading" && (
              <View style={styles.statusContainer}>
                ...
                >
                  <Bookmark size={28} color={brandColors.rust.DEFAULT} strokeWidth={2} />
                </View>
                <Text style={[styles.title, { color: colors.text }]}>Getting ready...</Text>
            ...
            {status === "saving" && (
              <View style={styles.statusContainer}>
                ...
                <Text style={[styles.title, { color: colors.text }]}>Saving to Backpocket</Text>
                {domain && (
                  <View style={[styles.urlPill, { backgroundColor: colors.muted }]}>
                    <Globe size={14} color={colors.mutedForeground} />
                    <Text
                      style={[styles.urlPillText, { color: colors.mutedForeground }]}
                      numberOfLines={1}
                    >
                      {domain}
                    </Text>
            ...
            {status === "success" && (
              <View style={styles.statusContainer}>
                <View style={[styles.successIconContainer, { backgroundColor: brandColors.mint }]}>
                  <AnimatedCheckmark color="#FFFFFF" />
                </View>
                <Text style={[styles.title, { color: colors.text }]}>Saved to Backpocket!</Text>
                {domain && (
                  <View style={[styles.urlPill, { backgroundColor: colors.muted }]}>
                    <Globe size={14} color={colors.mutedForeground} />
                    <Text
                ...
                {/* Visibility toggle */}
                {savedItem && <VisibilityToggleSection savedItem={savedItem} colors={colors} />}
                ...
                <View style={styles.actions}>
                  ...
                  >
                    <Text
                      style={[styles.secondaryButtonText, { color: colors.secondaryForeground }]}
                    >
                      Done
                    </Text>
                  </Pressable>
            ...
            {status === "duplicate" && duplicateSave && (
              <View style={styles.statusContainer}>
                ...
                <Text style={[styles.title, { color: colors.text }]}>Already in your pocket!</Text>
                ...
                {(duplicateSave.title || duplicateSave.siteName || duplicateSave.url) &&
                  duplicateSave.id && (
                    <Pressable
                    ...
                    >
                      {duplicateSave.siteName && (
                        <Text
                          style={[styles.duplicateSiteName, { color: colors.mutedForeground }]}
                          numberOfLines={1}
                        >
                          {duplicateSave.siteName}
                        </Text>
            ...
            {status === "error" && (
              <View style={styles.statusContainer}>
                ...
                <Text style={[styles.title, { color: colors.text }]}>Couldn't save</Text>
            ...
            {status === "auth_required" && (
              <View style={styles.statusContainer}>
                ...
                >
                  <LogIn size={28} color={brandColors.denim.DEFAULT} strokeWidth={2} />
                </View>
                <Text style={[styles.title, { color: colors.text }]}>Sign in to save</Text>
                <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
